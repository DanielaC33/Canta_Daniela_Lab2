...
namespace Canta_Daniela_Lab2.Data
{
    public class Canta_Daniela_Lab2Context : DbContext
    {
        ...
        public DbSet<Canta_Daniela_Lab2.Models.Category> Category { get; set; } = default!;
        public DbSet<Canta_Daniela_Lab2.Models.Member> Member { get; set; } = default!;
        public DbSet<Canta_Daniela_Lab2.Models.Borrowing> Borrowing { get; set; } = default!;
    }
}
