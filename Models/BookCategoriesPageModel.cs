...
namespace Canta_Daniela_Lab2.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Canta_Daniela_Lab2Context context, Book book)
        {
        ...
        public void UpdateBookCategories(Canta_Daniela_Lab2Context context, string[] selectedCategories, Book bookToUpdate)
        {
